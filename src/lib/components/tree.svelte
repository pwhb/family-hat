    ...
    function calculatePaths() {
        ...
        svgPaths = relationships
            .map((rel: any) => {
                ...
                const y1 = (rel.fromEnd === 'top' ? fromRect.top : fromRect.bottom) - containerRect.top + scrollY;
...
>
    ...
    <div class="relative z-10 flex min-h-full w-max flex-row items-center gap-12 mx-auto">
